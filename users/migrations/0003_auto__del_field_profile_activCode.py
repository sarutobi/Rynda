...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.activCode'
        db.delete_column('users_profile', 'activation_code')


    def backwards(self, orm):
        # Adding field 'Profile.activCode'
        db.add_column('users_profile', 'activCode',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, db_column='activation_code'),
                      keep_default=False)
