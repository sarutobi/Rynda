...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Users.id'
        db.delete_column('users_users', 'id')
        db.add_column('users_users', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

    def backwards(self, orm):

        # Changing field 'Users.id'
        db.alter_column('users_users', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True, db_column='id'))
