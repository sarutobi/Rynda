...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_users', 'forgotten_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, db_column='forgotten_password_time'),
                      keep_default=False)


        # Changing field 'Users.birthday'
        db.alter_column('users_users', 'birthday', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Users.birthday'
        raise RuntimeError("Cannot reverse this migration. 'Users.birthday' and its values cannot be restored.")
