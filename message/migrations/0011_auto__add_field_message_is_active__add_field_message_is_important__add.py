...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.is_active'
        db.add_column('message_message', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Message.is_important'
        db.add_column('message_message', 'is_important',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Message.is_anonymous'
        db.add_column('message_message', 'is_anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Message.is_removed'
        db.add_column('message_message', 'is_removed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Message.allow_feedback'
        db.add_column('message_message', 'allow_feedback',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.is_active'
        db.delete_column('message_message', 'is_active')

        # Deleting field 'Message.is_important'
        db.delete_column('message_message', 'is_important')

        # Deleting field 'Message.is_anonymous'
        db.delete_column('message_message', 'is_anonymous')

        # Deleting field 'Message.is_removed'
        db.delete_column('message_message', 'is_removed')

        # Deleting field 'Message.allow_feedback'
        db.delete_column('message_message', 'allow_feedback')
