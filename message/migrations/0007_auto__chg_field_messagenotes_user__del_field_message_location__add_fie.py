...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'MessageNotes.user' to match new field type.
        db.rename_column('message_messagenotes', 'user', 'user_id')
        # Changing field 'MessageNotes.user'
        db.alter_column('message_messagenotes', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Adding index on 'MessageNotes', fields ['user']
        db.create_index('message_messagenotes', ['user_id'])

        # Deleting field 'Message.location'
        db.delete_column('message_message', 'location_id')

        # Adding field 'Message.linked_location'
        db.add_column('message_message', 'linked_location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geozones.Location'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Message.user'
        db.alter_column('message_message', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, db_column='user_id'))
        # Adding index on 'Message', fields ['user']
        db.create_index('message_message', ['user_id'])


    def backwards(self, orm):
        # Removing index on 'Message', fields ['user']
        db.delete_index('message_message', ['user_id'])

        # Removing index on 'MessageNotes', fields ['user']
        db.delete_index('message_messagenotes', ['user_id'])


        # Renaming column for 'MessageNotes.user' to match new field type.
        db.rename_column('message_messagenotes', 'user_id', 'user')
        # Changing field 'MessageNotes.user'
        db.alter_column('message_messagenotes', 'user', self.gf('django.db.models.fields.IntegerField')())
        # Adding field 'Message.location'
        db.add_column('message_message', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Location'], null=True, db_column='location_id', blank=True),
                      keep_default=False)

        # Deleting field 'Message.linked_location'
        db.delete_column('message_message', 'linked_location_id')


        # Changing field 'Message.user'
        db.alter_column('message_message', 'user_id', self.gf('django.db.models.fields.IntegerField')(null=True, db_column='user_id'))
