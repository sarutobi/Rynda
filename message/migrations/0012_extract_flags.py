...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for a in orm['message.Message'].objects.all():
            a.is_active = ((a.flags & 1) == 1)
            a.is_important = ((a.flags & 2) == 2)
            a.is_anonymous = ((a.flags & 4) == 0)
            a.is_removed = ((a.flags & 0x10) == 0x10)
            a.allow_feedback = ((a.flags & 8) == 8)
            a.save()
