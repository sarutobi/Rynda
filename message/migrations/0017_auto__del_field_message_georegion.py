...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.georegion'
        db.delete_column(u'message_message', 'georegion_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Message.georegion'
        raise RuntimeError("Cannot reverse this migration. 'Message.georegion' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Message.georegion'
        db.add_column(u'message_message', 'georegion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geozones.Region']),
                      keep_default=False)
