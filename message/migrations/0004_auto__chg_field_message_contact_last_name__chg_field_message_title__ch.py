...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.contact_last_name'
        db.alter_column('message_message', 'contact_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Message.title'
        db.alter_column('message_message', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Message.contact_mail'
        db.alter_column('message_message', 'contact_mail', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Message.messageType'
        db.alter_column('message_message', 'message_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['message.MessageType'], null=True, db_column='message_type'))

        # Changing field 'Message.edit_key'
        db.alter_column('message_message', 'edit_key', self.gf('django.db.models.fields.CharField')(default='', max_length=40))

        # Changing field 'Message.source'
        db.alter_column('message_message', 'source', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Message.contact_phone'
        db.alter_column('message_message', 'contact_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Message.contact_first_name'
        db.alter_column('message_message', 'contact_first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

    def backwards(self, orm):

        # Changing field 'Message.contact_last_name'
        db.alter_column('message_message', 'contact_last_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Message.title'
        db.alter_column('message_message', 'title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Message.contact_mail'
        db.alter_column('message_message', 'contact_mail', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Message.messageType'
        db.alter_column('message_message', 'message_type', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['message.MessageType'], db_column='message_type'))

        # Changing field 'Message.edit_key'
        db.alter_column('message_message', 'edit_key', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Message.source'
        db.alter_column('message_message', 'source', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Message.contact_phone'
        db.alter_column('message_message', 'contact_phone', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Message.contact_first_name'
        db.alter_column('message_message', 'contact_first_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    models = {
        ...
        'message.message': {
            ...
            'contact_first_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'contact_last_name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'messageType': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['message.MessageType']", 'null': 'True', 'db_column': "'message_type'", 'blank': 'True'}),
