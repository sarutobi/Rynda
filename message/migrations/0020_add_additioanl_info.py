...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.additional_info'
        db.add_column(u'message_message', 'additional_info',
                      self.gf('jsonfield.fields.JSONField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.additional_info'
        db.delete_column(u'message_message', 'additional_info')
    ...
    models = {
        ...
        u'message.message': {
            ...
            'contact_mail': ('django.db.models.fields.EmailField', [], {'default': "''", 'max_length': '254', 'blank': 'True'}),
            'contact_phone': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'blank': 'True'}),
