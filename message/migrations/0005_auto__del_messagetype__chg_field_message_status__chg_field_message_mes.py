...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('message_message', 'status', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
        ...
        # Removing index on 'Message', fields ['messageType']
        db.delete_index('message_message', ['message_type'])


    def backwards(self, orm):
        # Adding index on 'Message', fields ['messageType']
        db.create_index('message_message', ['message_type'])
        ...
        # Changing field 'Message.status'
        db.alter_column('message_message', 'status', self.gf('django.db.models.fields.SmallIntegerField')())
    ...
    models = {
        ...
        'message.message': {
            ...
            'messageType': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'db_column': "'message_type'", 'blank': 'True'}),
