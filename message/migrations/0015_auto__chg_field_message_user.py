...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'message_message', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User'], db_column='user_id'))

    def backwards(self, orm):

        # Changing field 'Message.user'
        db.alter_column(u'message_message', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, db_column='user_id'))
