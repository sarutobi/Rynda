...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.georegion'
        db.add_column('message_message', 'georegion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['geozones.Region']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.georegion'
        db.delete_column('message_message', 'georegion_id')
