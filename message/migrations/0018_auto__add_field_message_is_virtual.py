...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.is_virtual'
        db.add_column(u'message_message', 'is_virtual',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.is_virtual'
        db.delete_column(u'message_message', 'is_virtual')
