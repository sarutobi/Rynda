...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.address'
        db.add_column('message_message', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


        # Changing field 'Message.contact_mail'
        db.alter_column('message_message', 'contact_mail', self.gf('django.db.models.fields.EmailField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Message.address'
        db.delete_column('message_message', 'address')


        # Changing field 'Message.contact_mail'
        db.alter_column('message_message', 'contact_mail', self.gf('django.db.models.fields.CharField')(max_length=200))
