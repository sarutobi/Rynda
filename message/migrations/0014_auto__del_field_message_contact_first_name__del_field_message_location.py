...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.contact_first_name'
        db.delete_column(u'message_message', 'contact_first_name')

        # Deleting field 'Message.location'
        db.delete_column(u'message_message', 'location')
        ...
        # Deleting field 'Message.contact_last_name'
        db.delete_column(u'message_message', 'contact_last_name')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Message.contact_first_name'
        raise RuntimeError("Cannot reverse this migration. 'Message.contact_first_name' and its values cannot be restored.")
        # Adding field 'Message.location'
        db.add_column(u'message_message', 'location',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(geography=True, null=True, blank=True),
                      keep_default=False)
        ...
        # User chose to not deal with backwards NULL issues for 'Message.contact_last_name'
        raise RuntimeError("Cannot reverse this migration. 'Message.contact_last_name' and its values cannot be restored.")
