...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Category.group' to match new field type.
        db.rename_column('core_category', 'group', 'group_id')
        # Changing field 'Category.group'
        db.alter_column('core_category', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CategoryGroup'], null=True))
        # Adding index on 'Category', fields ['group']
        db.create_index('core_category', ['group_id'])


    def backwards(self, orm):
        # Removing index on 'Category', fields ['group']
        db.delete_index('core_category', ['group_id'])


        # Renaming column for 'Category.group' to match new field type.
        db.rename_column('core_category', 'group_id', 'group')
        # Changing field 'Category.group'
        db.alter_column('core_category', 'group', self.gf('django.db.models.fields.IntegerField')(null=True))
