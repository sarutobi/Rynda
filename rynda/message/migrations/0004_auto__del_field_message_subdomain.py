...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.subdomain'
        db.delete_column(u'message_message', 'subdomain_id')


    def backwards(self, orm):
        # Adding field 'Message.subdomain'
        db.add_column(u'message_message', 'subdomain',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Subdomain'], null=True, db_column='subdomain_id', blank=True),
                      keep_default=False)
